...
getOneClient = (req,res) => {
    ...
    if(cliente){
        ...
        res.status(404).send("Não foi possivel encontra um cliente com esse ID");
    }
}   
...
createClient = (req,res) => {
    const cliente = req.body;
        ...
        res.status(406).send("Não foi possivel adcionar cliente");
...
updateClient = (req,res) =>{
    ...
    res.status(201).send("Cliente adcionado com sucesso");
}
